...
The search script lives inside this Skill's own directory, not the project directory. Resolve `<skill-directory>` to the directory containing this `SKILL.md`, then invoke the script by that full path:
